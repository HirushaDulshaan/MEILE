        ...
        <div className={"relative w-full z -50"}>
            <nav className={"bg-black px-6 py-4 shadow-md uppercase tracking-widest text-white relative z-50"}>
                <div className={"max-w-7xl mx-auto flex justify-between items-center"}>
                    <Link href="/dees" className={"text-2xl font-black hover:opacity-80 transition"}>D E E S</Link>


                    <div className={"hidden md:flex items-center gap-10 text-sm font-medium"}>
                        <Link href="/mens-wear" className="hover:text-gray-400 transition">
                            MEN
                        </Link>
                        <Link href="/womens-wear" className="hover:text-gray-400 transition">
                            WOMEN
                        </Link>
                    </div>
