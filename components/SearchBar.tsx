...
export default function SearchBar() {
    ...
    return (
        <div className="relative w-full max-w-md">
            ...
            {/* SEARCH RESULTS DROPDOWN - දකුණු පැත්තට Align කළා */}
            {results.length > 0 && (
                <div className="absolute top-full right-0 mt-4 w-[350px] md:w-[450px] bg-white rounded-[2rem] border border-slate-100 shadow-2xl p-4 z-[100] animate-in fade-in zoom-in-95 duration-200">
