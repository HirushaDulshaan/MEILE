                    ...
                    `}>
                        ...
                        `}>
                            ...
                            <div className="bg-white rounded-3xl border border-slate-50 overflow-hidden mb-3 shadow-sm">
                                ...
                                {openFilters.size && (
                                    <div className="px-4 pb-5 flex flex-wrap gap-2 animate-in fade-in slide-in-from-top-2">
                                        ...
                                        {sizes.map((s) => (
                                            <button key={s.id} onClick={() => setSelectedSize(s.sizeCode)} className={`w-10 h-8 rounded-lg text-[9px] font-black border-2 transition-all ${selectedSize === s.sizeCode ? 'bg-slate-900 border-slate-900 text-white shadow-md' : 'border-slate-100 text-slate-400 hover:border-blue-600'}`}>{s.sizeCode}</button>
                                        ))}
                                    </div>
                                )}
                            </div>
                            ...
                            <button
                                ...
                                className="lg:hidden w-full mt-6 bg-blue-600 text-white py-4 rounded-2xl font-black uppercase tracking-widest text-xs"
                            >
                                Show Results
                            </button>
                        </div>
