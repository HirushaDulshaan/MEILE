    ...
    useEffect(() => {
        const fetchMensProducts = async () => {
            try {
                ...
                const res = await fetch("/api/products?sectionId=2");
            ...
            <section className="max-w-7xl mx-auto px-6 py-16 lg:py-24">
                ...
                <div className="flex flex-col mb-12 border-l-4 border-blue-600 pl-6">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black tracking-tighter text-slate-900 uppercase">
                        Women's <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Fashion</span>
                    </h1>
